...
import { Breadcrumb, Layout, Menu, Button, Input, Switch, message as antdMessage, Spin, Card } from 'antd';
  ...
  return (
    <Layout>
      ...
      <Content style={{ padding: '0 48px' }}>
        ...
        <div style={{ padding: 24, minHeight: 380, background: '#fff', borderRadius: '8px' }}>
          <h1 className="text-4xl font-bold mb-4">User Dashboard</h1>

          <div className="mb-4">
            <h2 className="text-lg font-semibold mb-2">Copy Your Unique Link</h2>
            <div className="flex items-center">
              <Input value={profileUrl} disabled className="input input-bordered w-full p-2 mr-2" />
